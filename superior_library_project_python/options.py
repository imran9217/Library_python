...
class MainWin(Tk):
    def __init__(self):
        ...
        self.state('zoomed')
        self.title('SUPERIOR LIBRARY MANAGEMENT SYSTEMS(SLIMS)')
        self.a = StringVar()
        self.b = StringVar()
        ...
        def check():
            try:
                ...
                if not z:
                    ...
                    #label and input box
                    self.label3 = Label(self, text='SUPERIOR LIBRARY MANAGEMENT SYSTEM',fg='black',bg="white" ,font=('AlGERIAN', 30, 'bold'))
